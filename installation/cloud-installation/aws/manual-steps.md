...
* Follow the steps in [untitled.md](../../untitled.md "mention") for installing Vexdata server.
...
* Create an IAM policy from the [sample](https://dataops-store.s3.amazonaws.com/Vexdata\_server\_policy.json). Update the sample with the account number and bucket name from the above step.
